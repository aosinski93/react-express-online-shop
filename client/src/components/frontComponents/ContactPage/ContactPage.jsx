                ...
                <Grid container spacing={5}>
                    ...
                    <Grid item lg={4} md={4} sm={12} xs={12}>
                        <ContactOption
                            ...
                            optionData={<Link className={classes.contactData} href="mailto:contact@digistore.com">contact@digistore.com</Link>} />
                    </Grid>
                    <Grid item lg={4} md={4} sm={12} xs={12}>
                        <ContactOption
                            optionName='Personally'
                            optionIcon={<PersonIcon />}
                            optionData={<Typography className={classes.contactData} component={'span'}>2724 Rainy Day Drive 02107 Boston, MA</Typography>} />
                    </Grid>
                </Grid>
            </Container>
        </Box>
